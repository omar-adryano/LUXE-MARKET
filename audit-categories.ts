...
async function run() {
  ...
  for(const p of products) {
    ...
    if (n.includes('sneaker') || n.includes('shoe') || n.includes('boot') || n.includes('pump') || n.includes('sandal') || n.includes('shirt') || n.includes('dress') || n.includes('coat') || n.includes('suit') || n.includes('jacket') || n.includes('swimsuit')) {
       ...
       confidence = 'HIGH';
    } else if (n.includes('kitchen') || n.includes('cookware') || n.includes('mug') || n.includes('plate') || n.includes('bowl') || n.includes('cleaner') || n.includes('mop') || n.includes('vacuum') || n.includes('sofa') || n.includes('furniture')) {
       newCat = 'Home & Kitchen';
...
`;
  ...
  fs.writeFileSync('audit_report.txt', finalReport);
