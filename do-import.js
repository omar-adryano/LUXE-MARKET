...
// I must import CJDropshippingService. I will just fetch within this script to be completely independent.
...
async function run() {
  ...
  let page = Math.floor(cjCountBefore / 50) + 1; // skip early pages
  ...
  while (importedCount < 100) {
    ...
    for (const item of list) {
       ...
       try {
           ...
           if (n.includes('sneaker') || n.includes('shoe') || n.includes('boot') || n.includes('shirt') || n.includes('dress') || n.includes('coat') || n.includes('suit') || n.includes('jacket') || n.includes('pants') || n.includes('clothing')) {
             cat = 'Apparel & Fashion';
             ...
             cat = 'Fitness & Health';
           } else if (n.includes('travel') || n.includes('bag') || n.includes('luggage')) {
